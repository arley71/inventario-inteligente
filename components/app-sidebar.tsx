...
const navItems = [
  { href: "/admin/panel", label: "Panel Principal", icon: LayoutDashboard },
  { href: "/admin/revuelteria", label: "Revuelteria", icon: Leaf, showBadge: true },
  { href: "/admin/abarrotes", label: "Abarrotes", icon: Package },
  { href: "/admin/proveedores", label: "Proveedores", icon: Truck },
  { href: "/admin/ventas", label: "Registro de Ventas", icon: Receipt },
  { href: "/admin/pos", label: "Nueva Venta", icon: ShoppingCart },
]
...
export function AppSidebar() {
  ...
  const userRole = user?.role === "admin" ? "Administrador" : "Cajero"
